...
private:
    ...
    Engine::GLTexture m_textureFlower = {};
    Engine::GLTexture m_textureMeme  = {};
    Engine::GLTexture m_textureGrassBlock = {};
    ...
    Engine::ModelAsset plantModel;

    const int m_YLayer = 3;
    const int m_ZLayer = 12;
    const int m_XLayer = 12;
    // yzx 
    int m_layers[3][12][12] = {
        {
        ...
        },
        {
            ...
            {00,03,02,00,00,00,00,00,00,02,00,00},
